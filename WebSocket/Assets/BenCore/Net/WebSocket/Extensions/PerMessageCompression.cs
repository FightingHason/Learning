//*************************************************
//File:		PerMessageCompression.cs
//
//Brief:    Perp Message Compression
//
//Author:   Liuhaixia
//
...
namespace Ben.WebSocket.Extensions
{
    /// <summary>
        ...
        public bool ParseNegotiation(WebSocketResponse resp)
        {
            ...
            for (int i = 0; i < headerValues.Count; ++i)
            {
                ...
                for (int cv = 0; cv < parser.Values.Count; ++cv)
                {
                    ...
                    {
                        LoggerManager.Logger.Information("PerMessageCompression", "Enabled with header: " + headerValues[i]);
